...
import '../services/gift_v2_repository.dart';

/// Bottom-sheet gift picker for V2 catalog.
/// Caller provides the recipient + room context and a balance fetcher.
class GiftPickerSheetV2 extends StatefulWidget {
  const GiftPickerSheetV2({
    super.key,
  ...
  final GiftV2Repository repository;
  ...
  static Future<void> show(
    ...
    required GiftV2Repository repository,
  ...
  @override
  State<GiftPickerSheetV2> createState() => _GiftPickerSheetV2State();
}

class _GiftPickerSheetV2State extends State<GiftPickerSheetV2> with SingleTickerProviderStateMixin {
  late TabController _tab;
  Future<GiftV2Catalog>? _catalog;
  int _balance = 0;
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Expanded(
          child: FutureBuilder<GiftV2Catalog>(
            future: _catalog,
  ...
  Future<void> _send() async {
    ...
    } on GiftV2RepositoryException catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
