...
import '../screens/games/crazy_wheel_screen.dart';
import '../services/socket_service.dart';

/// Dev-only entry point that boots straight into عجلة الحظ.
///
...
///
///   flutter run -t lib/dev/crazy_wheel_preview.dart -d web-server \
...
class _PreviewApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MaterialApp(
        ...
        theme: ThemeData(fontFamily: 'ElMessiri', brightness: Brightness.dark),
        home: const CrazyWheelScreen(),
      );
}
